...
- [x] Lock Original BPM by default with an explicit unlock control for corrections
- [x] Add Reset to Detected BPM to restore the initially detected BPM, neutral
